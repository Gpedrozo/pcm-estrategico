drop view if exists public.schema_inventory_fks;

create view public.schema_inventory_fks as
select
  con.conname::text as constraint_name,
  nsp_src.nspname::text as table_schema,
  src.relname::text as table_name,
  att_src.attname::text as column_name,
  nsp_tgt.nspname::text as foreign_table_schema,
  tgt.relname::text as foreign_table_name,
  att_tgt.attname::text as foreign_column_name
