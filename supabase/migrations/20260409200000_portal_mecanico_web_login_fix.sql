...
-- não tem dispositivo vinculado. O frontend enviava uma string "portal-web-..."
...
-- ─────────────────────────────────────────────────────────────
-- 3. Tornar dispositivo_id nullable em log_mecanicos_login
--    (para suportar sessões web sem dispositivo vinculado)
-- ─────────────────────────────────────────────────────────────
...
-- log_validacoes_senha também precisa aceitar NULL
