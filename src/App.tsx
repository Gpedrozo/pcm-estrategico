...
import { EnvironmentGuard } from "@/security/EnvironmentGuard";
import { SystemOwnerGuard } from "@/security/SystemOwnerGuard";
          ...
          <EnvironmentGuard>
            <Routes>
              ...
              <Route element={<AppLayout />}>
                ...
                <Route path="/owner" element={<SystemOwnerGuard><MasterTI /></SystemOwnerGuard>} />
