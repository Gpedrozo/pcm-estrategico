              ...
              <SurfaceCard title="Gerenciar contrato">
                <div className="grid gap-2">
                  ...
                  <div className="grid gap-2 sm:grid-cols-3">
                    ...
                    <button className="rounded-lg border border-rose-300 bg-rose-50 dark:bg-rose-950/30 dark:border-rose-800/50 px-3 py-2 text-sm text-rose-700 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-950/50 disabled:opacity-50 transition-colors" disabled={busy || !selectedContractId} onClick={() => { if (window.confirm('Tem certeza que deseja excluir este contrato? Esta ação não pode ser desfeita.')) { runAction('delete_contract', { contract_id: selectedContractId }, 'Contrato excluído.'); setSelectedContractId(''); contractsQuery.refetch() } }}>Excluir contrato</button>
                  </div>
                </div>
              </SurfaceCard>
