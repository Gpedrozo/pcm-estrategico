...
const mainMenuItems = [{ title: 'Dashboard', url: '/dashboard', icon: LayoutDashboard }];
...
const ssmaMenuItems = [{ title: 'SSMA', url: '/ssma', icon: Shield }];
    ...
    <Sidebar className="border-r border-sidebar-border">
      ...
      <SidebarContent className="px-2 py-4">
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>{mainMenuItems.map(renderMenuLink)}</SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
        ...
        <SidebarGroup className="mt-4">
          ...
          <SidebarGroupContent>
            <SidebarMenu>{osMenuItems.map(renderMenuLink)}</SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
        ...
        <SidebarGroup className="mt-4">
          ...
          <SidebarGroupContent>
            <SidebarMenu>{relatoriosMenuItems.map(renderMenuLink)}</SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
        ...
        <SidebarGroup className="mt-4">
          ...
          <SidebarGroupContent>
            <SidebarMenu>{ssmaMenuItems.map(renderMenuLink)}</SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
        ...
        {isMasterTI && (
          <SidebarGroup className="mt-4">
            ...
            <SidebarGroupContent>
              <SidebarMenu>{renderMenuLink({ title: 'Painel Master', url: '/master-ti', icon: Crown })}</SidebarMenu>
            </SidebarGroupContent>
          </SidebarGroup>
        )}
        ...
        {isSystemOwner && (
          <SidebarGroup className="mt-4">
            ...
            <SidebarGroupContent>
              <SidebarMenu>{renderMenuLink({ title: 'Owner Portal', url: '/owner', icon: Shield })}</SidebarMenu>
            </SidebarGroupContent>
          </SidebarGroup>
        )}
      </SidebarContent>
